% DONE, pitäis olla oikeasti kunnossa
% ---------------------------------------------------------------------
% -------------- PREAMBLE ---------------------------------------------
% ---------------------------------------------------------------------
...
\usepackage{tabularx}  % useampisivuinen taulukko
\usepackage{etoolbox}
\usepackage{amssymb}
...
\INSTRUCTOR{Vanhempi yliopistonlehtori Juha Sorva}
...
\KEYWORDS{laiska evaluointi, normaalijärjestyksessä evaluointi, call-by-value, call-by-need, evaluointisemantiikka, evaluointistrategia, evaluointijärjestys, funktionaalinen ohjelmointi, Haskell}
...
\input{chapter_intro}
\input{chapter_methodology}
\input{chapter_terminology}
\input{chapter_history}
\input{chapter_applications}
\input{chapter_opinions}
